...
import (
	...
	"github.com/phillp/motus/streamapi/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "Stream Statistics API-cli",
		Short: `CLI client for the Stream Statistics API service`,
	}
	...
	c.UserAgent = "Stream Statistics API-cli/0"
